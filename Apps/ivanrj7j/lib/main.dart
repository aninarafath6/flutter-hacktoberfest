...
class _BalancePageState extends State<BalancePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget sendButton = ExpandableButton(text: "Send", icon: Icons.keyboard_double_arrow_up, mainColor: const Color(0xFFb0e6ee), expanded: widget.sendButtonExpanded,size: 0.65, onclickFunction: collapseButtons,);
    Widget receiveButton = ExpandableButton(text: "Receive", icon: Icons.keyboard_double_arrow_down, mainColor: const Color(0xFFcfedaa),size: 0.65, onclickFunction: collapseButtons, expanded: widget.receiveButtonExpanded,);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                      sendButton,
                      receiveButton,
                      ExpandableButton(text: "Send", icon: Icons.apps_rounded, mainColor: const Color(0xFFfce9c8),size: 0.65, expandable: false, onclickFunction: (){},),
                  ],
                )
